...
## Environments
- Preview: https://main--universal-deepak--deepaks007.aem.page/
- Live: https://main--universal-deepak--deepaks007.aem.live/
...
1. Open the `universal-deepak` directory in your favorite IDE and start coding :)
